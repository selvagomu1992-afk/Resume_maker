    ...
    <div className="max-w-4xl mx-auto bg-white text-gray-800 flex">
      ...
      <main className="w-2/3 p-6 space-y-5">
        ...
        {data.additional_info && data.additional_info.length > 0 && (
          <section>
            <h2 className="text-sm font-bold uppercase tracking-widest mb-2 pb-1 border-b" style={{ color: accentColor, borderColor: accentColor }}>Additional Information</h2>
            <div className="space-y-2">
              {data.additional_info.map((item, i) => (
                <div key={i} className="text-xs flex flex-col gap-0.5">
                  <div className="flex items-center gap-2 flex-wrap">
                    <span className="font-semibold" style={{ color: accentColor }}>{item.category}</span>
